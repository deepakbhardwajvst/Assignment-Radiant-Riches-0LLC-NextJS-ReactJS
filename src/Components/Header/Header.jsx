...
const Header = () => {
    ...
    const hambugerMenuRef = useRef(null);
    const toggleMenu = () => {
        setMenuOpen(!menuOpen);
    };
    //   <---- for hiding Hamburger menu
    const closeHambugerMenu = () => setMenuOpen(false);

    // Using the custom hook
    useOutsideClick(hambugerMenuRef, closeHambugerMenu);
    //    for hiding Hamburger menu ---->
    return (
        <nav className={`navbar`}>
            <div className="container1" ref={hambugerMenuRef}>
